...
#define UART4_INSTALL(w) extern "C" { \
...
#define UART5_INSTALL(w) extern "C" { \
...
#define UART6_INSTALL(w) extern "C" { \
...
#define UART9_INSTALL(w) extern "C" { \
...
#define UART10_INSTALL(w) extern "C" { \
