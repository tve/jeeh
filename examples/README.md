...
- **`dcf77`** - DCF77 clock decoder using the Nucleo-64 L412 board
...
- **`l432k-la`** - view Nucleo-32 L432 states with a logic analyser
- **`l432k-pm`** - view Nucleo-32 L432 power consumption with a power monitor
