...
Header | Nucleo | STM32 | Notes            |
-------|--------|-------|------------------|
 3-01  | D1     | PA9   | USART1 TX <-> RX |
 3-02  | D0     | PA10  | USART1 RX <-> TX |
 3-03  | RESET  | NRST  | -                |
 3-04  | GND    | -     | -                |
 3-05  | D2     | PA12  | LCD sel          |
 3-06  | D3     | PB0   | SRAM sel         |
 3-07  | D4     | PB7   | I2C sda          |
 3-08  | D5     | PA15  | I2C scl          |
 3-09  | D6     | PB6   | BMP vcc          |
 3-10  | D7     | PF0   | OSC32            |
 3-11  | D8     | PF1   | OSC32            |
 3-12  | D9     | PA8   | (spare on G431K) |
 3-13  | D10    | PA11  | BMP sel          |
 3-14  | D11    | PB5   | MOSI             |
 3-15  | D12    | PB4   | MISO             |
 4-01  | VIN    | -     | -                |
 4-02  | GND    | -     | -                |
 ...
 4-05  | A7     | PA2   | VCP TX           |
 4-06  | A6     | PA7   | SD sel           |
 4-07  | A5     | PA6   | I2C scl <-> A15  |
 4-08  | A4     | PA5   | I2C sda <-> B7   |
 4-09  | A3     | PA4   | DAC <-> ADC      |
 4-10  | A2     | PA3   | VCP RX           |
 4-11  | A1     | PA1   | ADC <-> DAC      |
 4-12  | A0     | PA0   | LED red          |
...
Another (L432?) board is used for tests with an RFM69 radio module:

![](rfm69.jpg)

Header | Nucleo | STM32 | RFM69 |
------:|:------:|-------|-------|
`3-08` | D5     | PA15  | DIO5  |
`3-09` | D6     | PB6   | RESET |
`3-12` | D9     | PA8   | DIO3  |
