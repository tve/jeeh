...
constexpr uart::Config UART_CONF {
    "A2:7,A15:3", USART2.ADDR, ena::USART2, 36,
...
constexpr spi::Config SPI_CONF {
    "B5:H5,B4,B3,A11:HP", SPI1.ADDR, ena::SPI1, 72,
    DMA1.ADDR, 1-1, 3-1,2-1, 1,1,
    Irq::DMA1_CH3, Irq::DMA1_CH2,
};
//CG]
...
constexpr i2c::Config I2C_CONF {
    "B7:OH4,B6", I2C1.ADDR, ena::I2C1, 36,
    DMA1.ADDR, 1-1, 4-1,5-1, 3,3,
    Irq::DMA1_CH4, Irq::DMA1_CH5, Irq::I2C1_EV, Irq::I2C1_ER,
};
//CG]
