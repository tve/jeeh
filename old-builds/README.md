...
`t11` | printf   | Check that printf works, with output redirected to the ITM/SWO stream.
...
There are also some board-specific tests in `old-tests/basic/onboard-*.cpp`.
