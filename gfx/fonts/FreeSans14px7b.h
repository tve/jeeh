const uint8_t FreeSans14px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeSans14px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,   4,    0,    1 },   // 0x20 ' '
  {     0,   1,  10,   5,    2,   -9 },   // 0x21 '!'
  {     2,   3,   3,   5,    1,   -9 },   // 0x22 '"'
  {     4,   8,   9,   8,    0,   -8 },   // 0x23 '#'
...
const GFXfont FreeSans14px7b PROGMEM = {
  (uint8_t  *)FreeSans14px7bBitmaps,
  (GFXglyph *)FreeSans14px7bGlyphs,
  0x20, 0x7E, 17 };
