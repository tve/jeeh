const uint8_t FreeSans24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeSans24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,   6,    0,    1 },   // 0x20 ' '
  {     0,   2,  18,   8,    3,  -17 },   // 0x21 '!'
  {     5,   6,   6,   8,    1,  -16 },   // 0x22 '"'
...
const GFXfont FreeSans24px7b PROGMEM = {
  (uint8_t  *)FreeSans24px7bBitmaps,
  (GFXglyph *)FreeSans24px7bGlyphs,
  0x20, 0x7E, 29 };
