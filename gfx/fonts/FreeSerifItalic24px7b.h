const uint8_t FreeSerifItalic24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeSerifItalic24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,   6,    0,    1 },   // 0x20 ' '
  {     0,   6,  16,   8,    1,  -15 },   // 0x21 '!'
  {    12,   7,   6,   8,    3,  -15 },   // 0x22 '"'
...
const GFXfont FreeSerifItalic24px7b PROGMEM = {
  (uint8_t  *)FreeSerifItalic24px7bBitmaps,
  (GFXglyph *)FreeSerifItalic24px7bGlyphs,
  0x20, 0x7E, 29 };
