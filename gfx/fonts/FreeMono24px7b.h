const uint8_t FreeMono24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeMono24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   3,  15,  14,    6,  -14 },   // 0x21 '!'
  {     6,   8,   7,  14,    3,  -14 },   // 0x22 '"'
...
const GFXfont FreeMono24px7b PROGMEM = {
  (uint8_t  *)FreeMono24px7bBitmaps,
  (GFXglyph *)FreeMono24px7bGlyphs,
  0x20, 0x7E, 24 };
