const uint8_t FreeMonoBoldOblique24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeMonoBoldOblique24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   6,  15,  14,    6,  -14 },   // 0x21 '!'
  {    12,   8,   7,  14,    6,  -13 },   // 0x22 '"'
...
const GFXfont FreeMonoBoldOblique24px7b PROGMEM = {
  (uint8_t  *)FreeMonoBoldOblique24px7bBitmaps,
  (GFXglyph *)FreeMonoBoldOblique24px7bGlyphs,
  0x20, 0x7E, 24 };
