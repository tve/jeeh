const uint8_t FreeSansBold24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeSansBold24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,   7,    0,    1 },   // 0x20 ' '
  {     0,   4,  17,   8,    3,  -16 },   // 0x21 '!'
  {     9,  10,   6,  11,    1,  -17 },   // 0x22 '"'
...
const GFXfont FreeSansBold24px7b PROGMEM = {
  (uint8_t  *)FreeSansBold24px7bBitmaps,
  (GFXglyph *)FreeSansBold24px7bGlyphs,
  0x20, 0x7E, 29 };
