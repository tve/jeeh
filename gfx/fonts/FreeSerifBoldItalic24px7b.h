const uint8_t FreeSerifBoldItalic24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeSerifBoldItalic24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,   6,    0,    1 },   // 0x20 ' '
  {     0,   8,  17,   9,    2,  -15 },   // 0x21 '!'
  {    17,   9,   7,  13,    4,  -15 },   // 0x22 '"'
...
const GFXfont FreeSerifBoldItalic24px7b PROGMEM = {
  (uint8_t  *)FreeSerifBoldItalic24px7bBitmaps,
  (GFXglyph *)FreeSerifBoldItalic24px7bGlyphs,
  0x20, 0x7E, 29 };
