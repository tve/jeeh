const uint8_t FreeMonoOblique24px7bBitmaps[] PROGMEM = {
  0x11, 0x11, 0x12, 0x22, 0x22, 0x00, 0x0E, 0xE0, 0xE7, 0xC6, 0xC6, 0xC6,
  0x84, 0x84, 0x84, 0x02, 0x40, 0x88, 0x12, 0x02, 0x40, 0x48, 0x7F, 0xC2,
...
const GFXglyph FreeMonoOblique24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   4,  15,  14,    6,  -14 },   // 0x21 '!'
  {     8,   8,   7,  14,    5,  -14 },   // 0x22 '"'
...
const GFXfont FreeMonoOblique24px7b PROGMEM = {
  (uint8_t  *)FreeMonoOblique24px7bBitmaps,
  (GFXglyph *)FreeMonoOblique24px7bGlyphs,
  0x20, 0x7E, 24 };
