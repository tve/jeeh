const uint8_t FreeMonoBold24px7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeMonoBold24px7bGlyphs[] PROGMEM = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   4,  15,  14,    5,  -14 },   // 0x21 '!'
  {     8,   8,   7,  14,    3,  -13 },   // 0x22 '"'
...
const GFXfont FreeMonoBold24px7b PROGMEM = {
  (uint8_t  *)FreeMonoBold24px7bBitmaps,
  (GFXglyph *)FreeMonoBold24px7bGlyphs,
  0x20, 0x7E, 24 };
